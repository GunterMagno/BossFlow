...
export const PhaseIcon = (props) => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g clipPath="url(#clip0_13_3832)">
      ...
      <path d="M9 12H9.0075" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </g>
    <defs>
      <clipPath id="clip0_13_3832">
        <rect width="18" height="18" fill="white" />
      </clipPath>
    </defs>
  </svg>
...
export const EffectIcon = (props) => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M12 2L15 8H9L12 2Z" stroke="currentColor" strokeWidth="1.5" fill="none" />
    <path d="M12 22L9 16H15L12 22Z" stroke="currentColor" strokeWidth="1.5" fill="none" />
  </svg>
);
