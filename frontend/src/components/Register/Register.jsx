...
function Register() {
    ...
    const validarFormulario = () => {
        ...
        if (!datosFormulario.nombreUsuario) {
            nuevosErrores.nombreUsuario = 'Es obligatorio introducir un nombre de usuario.';
            ...
            nuevosErrores.nombreUsuario = 'El nombre de usuario solo puede contener letras, números, guiones y guiones bajos.';
        }
        ...
        if (!datosFormulario.confirmarContrasena) {
            nuevosErrores.confirmarContrasena = 'Es obligatorio confirmar la contraseña.';
    ...
    return (
        <main className="register">
            ...
            <button 
                onClick={() => navigate('/')} 
                className="register__boton-volver"
                type="button"
            >
                <FiArrowLeft />
                Volver
            ...
            <article className="register__contenedor">
                ...
                <form onSubmit={manejoSubmit} className="register__formulario">
                    {/* Error general */}
                    {errores.submit && (<section className="register__error" role="alert">{errores.submit}</section>)}

                    {/* Campo nombre de usuario */}
                    <section className="register__campo">
                        <label htmlFor="nombreUsuario" className="register__etiqueta">Nombre de Usuario</label>
                        <input
                            type="text"
                            id="nombreUsuario"
                            name="nombreUsuario"
                            ...
                            disabled={cargando}
                        />
                        {errores.nombreUsuario && (<span className="register__mensaje-error" role="alert">{errores.nombreUsuario}</span>)}
                    </section>

                    {/* Campo correo */}
                    <section className="register__campo">
                        <label htmlFor="correo" className="register__etiqueta">Correo Electrónico</label>
                        <input
                            type="text"
                            id="correo"
                            name="correo"
                            ...
                            disabled={cargando}
                        />
                        {errores.correo && (<span className="register__mensaje-error" role="alert">{errores.correo}</span>)}
                    </section>

                    {/* Campo contraseña */}
                    <section className="register__campo">
                        <label htmlFor="contrasena" className="register__etiqueta">Contraseña</label>
                        <input
                            type="password"
                            id="contrasena"
                            name="contrasena"
                            ...
                            disabled={cargando}
                        />
                        {errores.contrasena && (<span className="register__mensaje-error" role="alert">{errores.contrasena}</span>)}
                    </section>

                    {/* Campo confirmar contraseña */}
                    <section className="register__campo">
                        <label htmlFor="confirmarContrasena" className="register__etiqueta">Confirmar Contraseña</label>
                        <input
                            type="password"
                            ...
                            disabled={cargando}
                        />
                        {errores.confirmarContrasena && (<span className="register__mensaje-error" role="alert">{errores.confirmarContrasena}</span>)}
                    </section>
                    ...
                    <section className="register__terminos">
                        ...
                        {errores.terminos && (<span className="register__mensaje-error" role="alert">{errores.terminos}</span>)}
                    </section>

                    {/* Botón submit */}
                    <button 
                        type="submit" 
                        className="register__boton"
                        disabled={cargando}
                    >
                        {cargando ? (
                            <>
